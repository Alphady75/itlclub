...
class AdherentType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->get('agency')->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                //$this->addCommercialFields($form->getParent(), $form->getData());
            }
        );
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                /*if ($commercial) {
                    ...
                    $agency = $commercial->getAgence();

                    $this->addCommercialFields($form, $agency);

                    $form->get('agency')->setData($agency);
                    $form->get('commercial')->setData($commercial);
                } else {
                    $this->addCommercialFields($form, null);
                }**/
            }
        );
    }
     ...
     * @return void
     */
    private function addCommercialFields($form, ?Agency $agence)
    {
        ...
        $builder = $form->getConfig()->getFormFactory()->createNamedBuilder(
            ...
            [
                ...
                'class' =>  User::class,
                'auto_initialize'   =>  false,
                'placeholder'   =>  $agence ? 'Sélectionnez un commercial' : 'Sélectionnez une agence',
                'choices'   =>  $agence ? $agence->getCommercial() : $this->userRepository->findByRoles('ROLE_COMMERCIAL'),
                //'choice_label' => 'street',
                'required'  =>  false,
                'constraints' => [
                    new NotBlank([
